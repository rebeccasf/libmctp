...
#ifndef _STARFIVE_PCIE_H
#define _STARFIVE_PCIE_H

#include "libmctp.h"

#define MCTP_STARFIVE_PCIE_BINDING_DEFAULT_BUFFER 1024
...
#define binding_to_starfive_pcie(b)                                                  \
	container_of(b, struct mctp_binding_starfive_pcie, binding)

#define STARFIVE_PCIE_PACKET_SIZE(x) (STARFIVE_MCTP_PCIE_VDM_HDR_SIZE + x)

/* driver device file */
#define STARFIVE_DRV_FILE "/dev/starfive-mctp"
