...
#include "libmctp-starfive-i3c.h"
...
{
	int rc = 0;
	/* mctp_starfive_i3c_poll always has nfds = 1 */
	assert(nfds == 1);
...
static void setup_test_case(struct mctp **mctp,
			    struct mctp_binding_starfive_i3c **starfive_i3c)
{
	*mctp = mctp_init();
	assert(mctp != NULL);

	*starfive_i3c = mctp_starfive_i3c_init();
	assert(starfive_i3c != NULL);

	mctp_register_bus_dynamic_eid(*mctp, &((*starfive_i3c)->binding));

	mctp_binding_set_tx_enabled(&((*starfive_i3c)->binding), true);
}

static void destroy_test_case(struct mctp **mctp,
			      struct mctp_binding_starfive_i3c **starfive_i3c)
{
	mctp_starfive_i3c_free(*starfive_i3c);
	mctp_destroy(*mctp);
}

static void test_starfive_i3c_pollin(void)
{
	int rc = 0, timeout = 100;

	test = i3c_poll_test_pollin;

	rc = mctp_starfive_i3c_poll(stubbed_fd, timeout);
	assert((rc & POLLIN) == POLLIN);
}

static void test_starfive_i3c_pollout(void)
{
	int rc = 0, timeout = 100;
...
static void test_starfive_i3c_poll_invalid_fd(void)
{
	int rc = -1, timeout = 100, fd = -1;

	test = i3c_poll_test_invalid_fd;

	rc = mctp_starfive_i3c_poll(fd, timeout);
	assert(rc == -1);
}

static void test_starfive_i3c_poll_timeout(void)
{
...
static void test_starfive_i3c_init(void)
{
	struct mctp_binding_starfive_i3c *starfive_i3c;
...
static void test_starfive_i3c_rx(void)
{
	struct mctp_binding_starfive_i3c *starfive_i3c = NULL;
	struct mctp *mctp = NULL;

	test = i3c_one_packet_read;
	setup_test_case(&mctp, &starfive_i3c);
	...
	mctp_starfive_i3c_rx(starfive_i3c, stubbed_fd);

	destroy_test_case(&mctp, &starfive_i3c);
}

static void test_starfive_i3c_rx_btu(void)
{
	struct mctp_binding_starfive_i3c *starfive_i3c = NULL;
	struct mctp *mctp = NULL;
...
static void test_starfive_i3c_rx_fragmented_messages(void)
{
	struct mctp_binding_starfive_i3c *starfive_i3c = NULL;
	struct mctp *mctp = NULL;
...
static void test_starfive_i3c_rx_bad_btu(void)
{
	struct mctp_binding_starfive_i3c *starfive_i3c = NULL;
	struct mctp *mctp = NULL;
...
static void test_starfive_i3c_rx_bad_fd(void)
{
	struct mctp_binding_starfive_i3c *starfive_i3c = NULL;
	struct mctp *mctp = NULL;
	bool packet_seen = false;
	...
	mctp_set_rx_all(mctp, test_rx_verify_payload, NULL);
	mctp_starfive_i3c_rx(starfive_i3c, bad_fd);
...
static void test_starfive_i3c_tx(void)
{
	struct mctp_starfive_i3c_pkt_private pkt_private = { .fd = stubbed_fd };
...
static void test_starfive_i3c_tx_btu(void)
{
	struct mctp_starfive_i3c_pkt_private pkt_private = { .fd = stubbed_fd };
	struct mctp_binding_starfive_i3c *starfive_i3c = NULL;
	struct mctp *mctp = NULL;
...
static void test_starfive_i3c_tx_fragmented_messages(void)
{
	struct mctp_starfive_i3c_pkt_private pkt_private = { .fd = stubbed_fd };
	struct mctp_binding_starfive_i3c *starfive_i3c = NULL;
	struct mctp *mctp = NULL;
...
static void test_starfive_i3c_tx_bad_fd(void)
{
	struct mctp_starfive_i3c_pkt_private pkt_private = { .fd = -2 };
	uint8_t test_payload[] = { i3c_tx_packet };
	struct mctp_binding_starfive_i3c *starfive_i3c = NULL;
	struct mctp *mctp = NULL;
	uint8_t dst_eid = 0x20;
...
int main(void)
{
	...
	test_starfive_i3c_init();

	/* Poll tests */
	test_starfive_i3c_pollin();
	test_starfive_i3c_pollout();
	test_starfive_i3c_poll_timeout();
	test_starfive_i3c_poll_invalid_fd();

	/* RX tests */
	test_starfive_i3c_rx();
	test_starfive_i3c_rx_btu();
	test_starfive_i3c_rx_fragmented_messages();
	test_starfive_i3c_rx_bad_btu();
	test_starfive_i3c_rx_bad_fd();

	/* TX tests */
	test_starfive_i3c_tx();
	test_starfive_i3c_tx_btu();
	test_starfive_i3c_tx_fragmented_messages();
	test_starfive_i3c_tx_bad_fd();
